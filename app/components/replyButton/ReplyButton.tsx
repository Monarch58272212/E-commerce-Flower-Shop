'use client';
import createReply from '@/app/actions/reply/createReply.action';
...
export default function ReplyButton({ userId, commentId }: IdReply) {
  ...
  const handleReplySubmit = async (e: React.FormEvent) => {
    ...
    try {
      const replyInComment = await createReply({ userId, message, commentId });
